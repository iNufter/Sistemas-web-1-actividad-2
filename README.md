...
<body>
    <div class="dive2">
        <h1>Resultados</h1>
       <center>
         <img src="img/bibble.jpg" alt="bibble" width="150">
         <?php
            $Nombre = $_POST['Name'];
            $Edad = $_POST['Age'];
            $Ciudad = $_POST['City'];
...
<body>
    <div class="dive">
            ...
            <br>
            <h2>Ingresa los datos que te piden</h2>
            <br>
